...
public class ListadoEnviosAsignados extends JPanel {

	/**
	 * Create the panel.
	 */
	public ListadoEnviosAsignados() {
		setForeground(UIManager.getColor("Button.background"));
		setLayout(null);
	
		JLabel titulo = new JLabel("ENVIOS ASIGNADOS");
		...
		String[][] cartas= controlador.listadoCartasAsignados();		
		final String[] cabeceraTabla= {"Codigo","Fecha","Origen", 
				"Destino","Precio","Nombre Mensajero"};
		...
		scrollPane.setBounds(10, 61, 488, 115);
		add(scrollPane);
		...
		String[][] paquetes= controlador.listadoPaquetesAsignados();		
		final String[] cabeceraPaqueteTabla= {"Codigo","Fecha","Origen", 
				"Destino","Peso","PrecioKilo","Nom. Men."};
		...
		scrollPane_1.setBounds(10, 203, 488, 115);
		add(scrollPane_1);
