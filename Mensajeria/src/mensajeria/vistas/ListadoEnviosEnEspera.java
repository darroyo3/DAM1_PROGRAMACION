...
public class ListadoEnviosEnEspera extends JPanel {

	/**
	 * Create the panel.
	 */
	public ListadoEnviosEnEspera() {
		...
		String[][] cartas= controlador.listadoCartasEnEspera();		
		...
		String[][] paquetes= controlador.listadoPaquetesEnEspera();		
